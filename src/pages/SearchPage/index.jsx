        ...
        <>
            <div className="header_style">
                <div className="input_button">
                    <input onChange={getInput} className="input_style" placeholder="搜电影，演职员" value={input}/>
                    <a className="button_style" type="submit" onClick={onSearch}></a>
                </div>
            </div>
            {movies.length === 0 ? <Empty className="empty_style"/> : <div className="movie-list-card-col">
                {
                    movies.map((item, idx) => (
            ...
            <div>
                {movies.length !== 0 &&
                <div className="movie-list-pagination"><Pagination
